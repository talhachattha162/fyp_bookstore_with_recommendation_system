  ...
  Widget build(BuildContext context) {
    ...
    return TextInputField(
                                ...
                                suffixIcon: IconButton(
                                  icon:  Consumer<LoginSignupProvider>(
    builder: (context, loginProvider, _) {
    return
    Icon(
    loginProvider.obscure
                                  ...
                                  onPressed: () {
                                    if(Provider.of<LoginSignupProvider>(context, listen: false).obscure==false){
                                      Provider.of<LoginSignupProvider>(context, listen: false).obscure=true;
                                    }
                                    else{
                                      Provider.of<LoginSignupProvider>(context, listen: false).obscure=false;
                                    }
                                    // if (mounted) {
                                    //   setState(() {
                                ...
                                isPassword: loginProvider.obscure,
                                validator: (value) {
        ...
        loginProvider.isLoading == true
          ...
          onPressed: () async {
            if (_formKey.currentState!.validate()) {
              Provider
                  .of<LoginSignupProvider>(context, listen: false)
                  .isLoading = true;
              // if (mounted) {
              //   setState(() {
              //     isLoading = true;
    ...
    builder: (context, loginProvider, _) {
    return
    loginProvider.isGoogleLoading == true
                                ? const CircularProgressIndicator()
                                : SignInButton(
                                    Buttons.Google,
                                    text: "Sign in with Google",
                                    onPressed: () async {
                                      Provider.of<LoginSignupProvider>(context, listen: false).isGoogleLoading=true;
                                      // try {
                                      // if (mounted) {
                                      //   setState(() {
                                      ...
                                      Provider.of<LoginSignupProvider>(context, listen: false).isGoogleLoading=false;
